  ...
  methods: {
    ...
    loadAllVideoCollections(mq) {
      return [
        {
          name: 'commercials',
          thumbnail: `/static/works/video/commercials/commercial_${mq}_1.jpeg`,
        ...
        },
        {
          name: 'films_and_tv',
          thumbnail:
            `/static/works/video/films_and_tv/films_and_tv_${mq}_1.jpeg`,
